...
def verify_access_token(token: str, credentials_exception):
    ...
    try:
        ...
        token_data = user.TokenData(
            id=id
        )  # -> Se valida antes, pero sirve en caso de que vengan mas cosas en el payload, valida tipos de datos
    except JWTError:
        raise credentials_exception
...
def get_current_user(
    ...
    account_verification: bool = False,
):
